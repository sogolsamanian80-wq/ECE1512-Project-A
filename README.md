...
1. Open Token_Pruning_Testing_ProjectA.ipynb
2. If the necessary libraries are not already added, run sections 1 and 2 first.
3. Select your preferred values and add the links to your selected images in section 3 based on comments.
4. The model setup uses the code from: https://huggingface.co/blog/smolvlm
5. Token Pruning Functions are defined for random selection; however, it is possible to add more methods for future work.
